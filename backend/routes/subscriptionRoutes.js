...
router.post('/subscribe', isAuthenticated, isUser, subscriptionController.createSubscription);
router.post('/cancel/:subscriptionId', isAuthenticated, isUser, subscriptionController.cancelSubscription);
router.post('/upgrade', isAuthenticated, isUser, subscriptionController.upgradeSubscription);
router.post('/downgrade', isAuthenticated, isUser, subscriptionController.downgradeSubscription);
